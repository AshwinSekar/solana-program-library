...
mod tests {
    use {
        ...
        solana_sdk::{
            ...
            signature::Keypair,
            signer::Signer,
            sysvar::instructions::{self, BorrowedAccountMeta, BorrowedInstruction},
        },
        std::sync::{Arc, RwLock},
    };
    ...
    fn construct_instructions_and_sysvar<'a>(
        node_pubkey: Pubkey,
        slot: Slot,
        sigverify_data: &'a DuplicateBlockProofSigverifyData,
